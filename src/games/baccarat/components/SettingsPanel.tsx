      ...
      >
        ...
        <section className="mb-6">
          ...
          <label className="mt-1.5 flex items-center justify-between rounded-lg bg-black/20 px-3 py-2 text-sm text-white/75">
            <span>
              Squeeze the cards
              <span className="ml-2 text-[11px] text-white/35">tap to reveal, slow deal</span>
            </span>
            <input
              type="checkbox"
    ...
    <div className="rounded-lg bg-black/20">
      <div className="flex items-center justify-between px-3 py-2">
        ...
        <label className="cursor-pointer">
          <input type="checkbox" checked={on} onChange={onToggle} className="accent-brass" />
        </label>
      </div>
      {showInfo && open && (
        <div className="border-t border-white/5 px-3 py-2">
          ...
          {bet.notes && <p className="mt-1 text-[10px] leading-relaxed text-white/35">{bet.notes}</p>}
        </div>
      )}
    </div>
  );
